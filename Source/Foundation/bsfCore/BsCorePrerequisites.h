...
#define BS_ALL_LAYERS 0xFFFFFFFFFFFFFFFF
	...
	B3D_LOG_CATEGORY(CoreThread, 20)
	B3D_LOG_CATEGORY(Renderer, 21)
	B3D_LOG_CATEGORY(Scene, 22)
	B3D_LOG_CATEGORY(Physics, 23)
	B3D_LOG_CATEGORY(Audio, 24)
	B3D_LOG_CATEGORY(RenderBackend, 25)
	B3D_LOG_CATEGORY(BSLCompiler, 26)
	B3D_LOG_CATEGORY(Particles, 27)
	B3D_LOG_CATEGORY(Resources, 28)
	B3D_LOG_CATEGORY(FBXImporter, 29)
	B3D_LOG_CATEGORY(PixelUtility, 30)
	B3D_LOG_CATEGORY(Texture, 31)
	B3D_LOG_CATEGORY(Mesh, 32)
	B3D_LOG_CATEGORY(GUI, 33)
	B3D_LOG_CATEGORY(Profiler, 34)
	B3D_LOG_CATEGORY(Material, 35)
	B3D_LOG_CATEGORY(FreeImageImporter, 36)
	B3D_LOG_CATEGORY(Script, 37)
	B3D_LOG_CATEGORY(Importer, 38)
	B3D_LOG_CATEGORY(Network, 39)
} // namespace bs
