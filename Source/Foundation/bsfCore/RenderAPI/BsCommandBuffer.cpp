...
CommandBuffer::CommandBuffer(GpuQueueType queueType)
...
SPtr<CommandBuffer> CommandBuffer::Create(GpuQueueType queueType)
{
	SPtr<CommandBuffer> commandBuffer = CommandBufferManager::Instance().Create(queueType);
