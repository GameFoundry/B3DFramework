...
namespace bs
{
	...
	public:
		...
		ConstIterator ConstBegin() const { return mElements; }
		ConstIterator ConstEnd() const { return mElements + mSize; }
		...
		ConstReverseIterator ConstReverseBegin() const { return ConstReverseIterator(End()); }
		ConstReverseIterator ConstReverseEnd() const { return ConstReverseIterator(Begin()); }
