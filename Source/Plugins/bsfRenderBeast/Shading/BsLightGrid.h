...
namespace bs
{
	namespace ct
	{
		...
		public:
			...
			void SetParams(CommandBuffer& commandBuffer, const Vector3I& gridSize, const SPtr<GpuBuffer>& gridParams, const SPtr<GpuBuffer>& lightsBuffer, const SPtr<GpuBuffer>& probesBuffer);

			/** Binds the material for rendering, sets up per-camera parameters and executes it. */
			void Execute(CommandBuffer& commandBuffer, const RendererView& view);
		...
		public:
			...
			/** Binds parameter buffers and prepares any internal buffers. Must be called before Execute(). */
			void SetParams(CommandBuffer& commandBuffer, const Vector3I& gridSize, const SPtr<GpuBuffer>& gridParams, const SPtr<GpuBuffer>& lightLLHeads, const SPtr<GpuBuffer>& lightLL, const SPtr<GpuBuffer>& probeLLHeads, const SPtr<GpuBuffer>& probeLL);
		...
		public:
			...
			void UpdateGrid(CommandBuffer& commandBuffer, const RendererView& view, const VisibleLightData& lightData, const VisibleReflProbeData& probeData, bool noLighting);
