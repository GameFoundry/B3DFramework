...
namespace bs
{
	namespace ct
	{
		...
		public:
			...
			void SetParams(const Vector3I& gridSize, const SPtr<GpuBuffer>& gridParams, const SPtr<GpuBuffer>& lightsBuffer, const SPtr<GpuBuffer>& probesBuffer);
		...
		public:
			...
			/** Binds parameter buffers and prepares any internal buffers. Must be called before execute(). */
			void SetParams(const Vector3I& gridSize, const SPtr<GpuBuffer>& gridParams, const SPtr<GpuBuffer>& lightLLHeads, const SPtr<GpuBuffer>& lightLL, const SPtr<GpuBuffer>& probeLLHeads, const SPtr<GpuBuffer>& probeLL);
