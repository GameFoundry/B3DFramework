...
namespace bs
{
	namespace ct
	{
		...
		public:
			...
			void Execute(CommandBuffer& commandBuffer, const SPtr<Texture>& source, u32 face, u32 mip, const SPtr<RenderTarget>& target);
		...
		public:
			 ...
			 */
			void Execute(CommandBuffer& commandBuffer, const SPtr<Texture>& source, u32 face, const SPtr<GpuBuffer>& output);
		...
		public:
			 ...
			 */
			void Execute(CommandBuffer& commandBuffer, const SPtr<GpuBuffer>& source, u32 numCoeffSets, const SPtr<Texture>& output, u32 outputIdx);
		...
		public:
			 ...
			 */
			void Execute(CommandBuffer& commandBuffer, const SPtr<Texture>& source, u32 face, u32 coefficientIdx, const SPtr<RenderTarget>& output);
		...
		public:
			 ...
			 */
			void Execute(CommandBuffer& commandBuffer, const SPtr<Texture>& source, u32 face, u32 sourceMip, const SPtr<RenderTarget>& output);
		...
		public:
			 ...
			 */
			void Execute(CommandBuffer& commandBuffer, const SPtr<Texture>& source, u32 sourceMip, const Vector2I& outputOffset, u32 coefficientIdx, const SPtr<RenderTarget>& output);
		...
		public:
			 ...
			 * a cubemap.
			 */
			void Execute(CommandBuffer& commandBuffer, const SPtr<Texture>& shCoeffs, u32 face, const SPtr<RenderTarget>& target);
		...
		{
		public:
			void FilterCubemapForSpecular(CommandBuffer& commandBuffer, const SPtr<Texture>& cubemap, const SPtr<Texture>& scratch) const override;
			void FilterCubemapForIrradiance(CommandBuffer& commandBuffer, const SPtr<Texture>& cubemap, const SPtr<Texture>& output) const override;
			void FilterCubemapForIrradiance(CommandBuffer& commandBuffer, const SPtr<Texture>& cubemap, const SPtr<Texture>& output, u32 outputIdx) const override;
			void ScaleCubemap(CommandBuffer& commandBuffer, const SPtr<Texture>& src, u32 srcMip, const SPtr<Texture>& dst, u32 dstMip) const override;
		...
		private:
			 ...
			 */
			static void DownsampleCubemap(CommandBuffer& commandBuffer, const SPtr<Texture>& src, u32 srcMip, const SPtr<Texture>& dst, u32 dstMip);
			 ...
			 */
			static void FilterCubemapForIrradianceNonCompute(CommandBuffer& commandBuffer, const SPtr<Texture>& cubemap, u32 outputIdx, const SPtr<RenderTexture>& output);
		};
