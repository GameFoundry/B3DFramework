...
namespace bs
{
	namespace ct
	{
		...
		public:
			 ...
			 */
			const GLVertexArrayObject& GetVao(const SPtr<GLSLGpuProgram>& vertexProgram, const SPtr<VertexDeclaration>& vertexDecl, const std::array<SPtr<VertexBuffer>, 32>& boundBuffers);
