...
namespace b3d::render
{
	 ...
	 * ranges from the device's descriptor manager on first bind, so the pool holds no storage of its own and only
	 * enforces the requested set capacity.
	 */
	...
	private:
		...
		/** Number of sets handed out since the pool was last reset, limited by GpuParameterSetPoolCreateInformation::MaxSets. */
