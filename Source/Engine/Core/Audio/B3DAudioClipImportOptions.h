...
namespace b3d
{
	...
	class B3D_EXPORT B3D_SCRIPT_EXPORT(DocumentationGroup(Importer), Assembly(Engine), Assembly(Editor), API(FrameworkOnly)) AudioClipImportOptions : public ImportOptions
	{
	public:
