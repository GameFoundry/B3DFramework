...
namespace bs
{
	...
	class B3D_SCRIPT_INTEROP_EXPORT ScriptSpriteTextureCreateInformation : public ScriptObject<ScriptSpriteTextureCreateInformation>
	{
	public:
		SCRIPT_OBJ(kEngineAssembly, kEngineNs, "SpriteTextureCreateInformation")
	...
	private:
		ScriptSpriteTextureCreateInformation(MonoObject* managedInstance);
