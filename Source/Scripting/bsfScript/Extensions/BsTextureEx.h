...
namespace bs
{
	...
	public:
		 ...
		 */
		BS_SCRIPT_EXPORT(ExtensionMethodForType(Texture),n:GetPixels)
		 ...
		 *					cubemap array it has to be a multiple of 6).
		 */
		BS_SCRIPT_EXPORT(ExtensionMethodForType(Texture),n:SetPixels)
